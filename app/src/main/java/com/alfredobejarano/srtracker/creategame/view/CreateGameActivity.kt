...
class CreateGameActivity : BaseActivity<Unit>(), HeroPicker.OnHeroChangedListener {
     ...
     * and a hero changed listener to the hero picker.
     */
    override fun initializeView() {
        cg_save.setOnClickListener { sendMatchToPresenter() }
        cg_hero_picker.heroChangedListener = this // Sets the hero changed listener for the hero picker view.
    }
    ...
    private fun sendMatchToPresenter() {
        ...
        presenter.storeMatch(Match(
                ...
                hero = heroes,
                map = cg_map_field.text.toString(),
    ...
    override fun displayError(message: Int) {
        ...
        val view = when (message) { // Sets a view for animate when an error happens.
            ...
            R.string.please_enter_a_map_name -> cg_map_field
            else -> cg_sr_field
        }
